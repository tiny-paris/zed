...
pub struct CursorAnimationSettings {
    ...
    pub trail_size: f32,
    pub glow: CursorGlowSettings,
}

#[derive(Copy, Clone, Debug, PartialEq)]
pub struct CursorGlowSettings {
    pub enabled: bool,
    pub blur_factor: f32,
    pub opacity: f32,
}
...
impl Settings for EditorSettings {
    fn from_settings(content: &settings::SettingsContent) -> Self {
        ...
        let cursor_glow = cursor_animation.glow.unwrap();
        ...
        Self {
            ...
            cursor_animation: CursorAnimationSettings {
                ...
                glow: CursorGlowSettings {
                    enabled: cursor_glow.enabled.unwrap(),
                    blur_factor: cursor_glow.blur_factor.unwrap(),
                    opacity: cursor_glow.opacity.unwrap(),
                },
            },
